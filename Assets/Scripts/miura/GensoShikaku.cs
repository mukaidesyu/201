...
public class GensoShikaku : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (panelEve == EventStatus.Kinoko || panelEve == EventStatus.Sakana || panelEve == EventStatus.Kari1
             ...
             || panelEve == EventStatus.Milk  || panelEve == EventStatus.Egg || panelEve == EventStatus.Bread ||
             panelEve == EventStatus.Egg2 || panelEve == EventStatus.Milk2   || panelEve == EventStatus.Pasta || panelEve == EventStatus.Kinoko2)
                {
                    blueCircle.Play();
                    redCircle.Stop();
             }
